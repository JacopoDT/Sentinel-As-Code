...
[`AnalyticalRules/Community/`](./Community/), organised by
...
| **Disabled at deploy time** | `enabled: false` regardless of the YAML's `enabled` field | Rules are evaluated by the deployer and forced disabled in [`Deploy-CustomContent.ps1:1155`](../../Deploy/Deploy-CustomContent.ps1). Reviewers enable individual rules in the Sentinel portal after deployment |
...
- **Path:** [`AnalyticalRules/Community/Dalonso/`](./Community/Dalonso/)
- **Import script:** [`Scripts/Import-CommunityRules.ps1`](../../Deploy/Import-CommunityRules.ps1)
...
| Auto-generated summary | [`./Community/Dalonso.md`](../Community/Dalonso.md) | Per-category rule listings, last-sync date, source commit. **Not hand-edited** — regenerated each run alongside this governance doc |
...
in the target folder. It also regenerates [`./Community/Dalonso.md`](../Community/Dalonso.md)
...
See [`Scripts/Import-CommunityRules.ps1`](../../Deploy/Import-CommunityRules.ps1)
...
- [Analytical Rules](Analytical-Rules.md) — YAML schema applies identically
  to community rules
- [Sentinel Drift Detection](../../Deploy/Sentinel-Drift-Detection.md) — what happens
