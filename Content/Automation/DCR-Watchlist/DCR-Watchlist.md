...
For general watchlist authoring conventions, see [Watchlists](../Watchlists/Watchlists.md).
...
| **Variable group** | `sentinel-deployment` with `sentinelResourceGroup` and `sentinelWorkspaceName` (shared with the main deploy pipeline — see [Pipelines](../../../../../Pipelines/Pipelines.md)) |
