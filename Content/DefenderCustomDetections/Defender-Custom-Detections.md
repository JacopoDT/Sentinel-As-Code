...
Grant this in **Entra ID > App Registrations > API Permissions > Microsoft Graph**. The bootstrap script [`Scripts/Setup-ServicePrincipal.ps1`](../../Deploy/Setup-ServicePrincipal.ps1) handles this — see [Scripts](../../Deploy/Scripts.md#setup-serviceprincipalps1).
...
Handled by [`Scripts/Deploy-DefenderDetections.ps1`](../../Deploy/Deploy-DefenderDetections.ps1) and Stage 5 of the deploy pipeline. See [Scripts](../../Deploy/Scripts.md#deploy-defenderdetectionsps1) and [Pipelines](../../Pipelines/Pipelines.md).
