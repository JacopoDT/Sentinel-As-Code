...
- Post-deploy: managed-identity role assignments are handled by [`Scripts/Set-PlaybookPermissions.ps1`](../../Deploy/Set-PlaybookPermissions.ps1) — see [Scripts.md](../../Deploy/Scripts.md#set-playbookpermissionsps1)
