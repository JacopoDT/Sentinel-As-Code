...
- Deployment is handled by [`Scripts/Deploy-CustomContent.ps1`](../../Deploy/Deploy-CustomContent.ps1) — see [Scripts.md](../../Deploy/Scripts.md#deploy-customcontentps1)
- For a watchlist that's auto-populated by an Azure Automation runbook (DCR inventory), see [DCR Watchlist](../Automation/DCR-Watchlist/DCR-Watchlist.md)
