...
# ---------------------------------------------------------------------------
# Deploy Custom Hunting Queries (YAML â†’ Saved Searches)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Deploy Custom Summary Rules (JSON â†’ Log Analytics summarylogs)
# ---------------------------------------------------------------------------
function Deploy-CustomSummaryRules {
    ...
    foreach ($file in $jsonFiles) {
        ...
        try {
            ...
            Write-PipelineMessage "Processing: $displayName (bin: $($rule.binSize)min â†’ $($rule.destinationTable)) [$($file.Name)]" -Level Info
            ...
            if ($WhatIf) {
                Write-PipelineMessage "[WhatIf] Would deploy summary rule: $displayName (bin: $($rule.binSize)min â†’ $($rule.destinationTable))" -Level Info
                $counters.Deployed++
            }
            else {
                Invoke-SentinelApi -Uri $uri -Method Put -Headers $script:AuthHeader -Body $body | Out-Null
...
function Main {
    ...
    Write-PipelineMessage ("â”€" * 60) -Level Info
    ...
    # â”€â”€ Step 2/12: Authentication â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Write-PipelineMessage "" -Level Info
    Write-PipelineMessage "Step 2/12: Authentication" -Level Section
    Write-PipelineMessage ("â”€" * 60) -Level Info
    Connect-AzureEnvironment

    # â”€â”€ Step 3/12: Smart Deployment â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Write-PipelineMessage "" -Level Info
    ...
    # â”€â”€ Step 4/12: Dependency Graph & Pre-Flight â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Write-PipelineMessage "" -Level Info
    ...
    # â”€â”€ Step 5/12: Deploy Parsers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Write-PipelineMessage "" -Level Info
    ...
    # â”€â”€ Step 6/12: Deploy Watchlists â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Write-PipelineMessage "" -Level Info
    ...
    # â”€â”€ Step 7/12: Deploy Detections â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Write-PipelineMessage "" -Level Info
    ...
    # â”€â”€ Step 8/12: Deploy Hunting Queries â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Write-PipelineMessage "" -Level Info
    ...
    # â”€â”€ Step 9/12: Deploy Playbooks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Write-PipelineMessage "" -Level Info
    ...
    # â”€â”€ Step 10/12: Deploy Workbooks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Write-PipelineMessage "" -Level Info
    ...
    # â”€â”€ Step 11/12: Deploy Automation Rules â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Write-PipelineMessage "" -Level Info
    ...
    # â”€â”€ Step 12/12: Deploy Summary Rules â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Write-PipelineMessage "" -Level Info
