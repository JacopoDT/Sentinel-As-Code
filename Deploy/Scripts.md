...
| `Test-SentinelRuleDrift.ps1` | Detects portal-edited rules and absorbs Custom drift | See [Sentinel Drift Detection](../../Deploy/Sentinel-Drift-Detection.md) |
...
- [Analytical-Rules.md](../AnalyticalRules/Analytical-Rules.md) — YAML analytics rule schema
- [Watchlists.md](../Watchlists/Watchlists.md) — Watchlist metadata and CSV format
- [Playbooks.md](../Playbooks/Playbooks.md) — ARM template requirements
- [Workbooks.md](../Workbooks/Workbooks.md) — Gallery template JSON format
- [Hunting-Queries.md](../HuntingQueries/Hunting-Queries.md) — Hunting query YAML schema
- [Automation-Rules.md](../AutomationRules/Automation-Rules.md) — Automation rule JSON schema
- [Summary-Rules.md](../SummaryRules/Summary-Rules.md) — Summary rule JSON schema
...
See [Defender-Custom-Detections.md](../DefenderCustomDetections/Defender-Custom-Detections.md) for the full YAML schema, response action types, and impacted asset identifiers.

---

## Import-CommunityRules.ps1

Imports community analytical rules from external repositories into the local codebase. Currently supports the David Alonso (Dalonso) Security repository. See [Community-Rules.md](../AnalyticalRules/Community-Rules.md) for the full contribution model.
