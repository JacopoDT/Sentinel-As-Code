...
The deploy script ([`Scripts/Deploy-CustomContent.ps1`](../Deploy/Deploy-CustomContent.ps1)) reads the same `playbookResourceGroup` variable and routes Logic App ARM deployments accordingly. See [Playbooks](../Content/Playbooks/Playbooks.md) for the deploy-side detail.
