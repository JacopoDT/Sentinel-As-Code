...
| --- | --- | --- |
| [`Pipelines/Sentinel-Deploy.yml`](Sentinel-Deploy.yml) | End-to-end deploy: Bicep infra + Content Hub + custom content + Defender XDR | Weekly, Mon 04:00 UTC |
| [`Pipelines/Sentinel-Drift-Detect.yml`](Sentinel-Drift-Detect.yml) | Detect rules edited in the portal, auto-PR Custom drift back into the repo | Daily, 06:00 UTC. See [Sentinel Drift Detection](../../Deploy/Sentinel-Drift-Detection.md) |
| [`Pipelines/Sentinel-DCR-Inventory.yml`](Sentinel-DCR-Inventory.yml) | Deploy the DCR-watchlist sync runbook | On change to `Automation/DCR-Watchlist/**`. See [DCR Watchlist](../Automation/DCR-Watchlist/DCR-Watchlist.md) |
